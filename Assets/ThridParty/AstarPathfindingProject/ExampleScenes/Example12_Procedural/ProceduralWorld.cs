...
namespace Pathfinding.Examples
{
    ...
    public class ProceduralWorld : MonoBehaviour
    {
        ...
        public enum RotationRandomness { AllAxes, Y }
                    ...
                    else
                    {
                        ...
                        for (int sx = 0; sx < world.subTiles; sx++)
                        {
                            for (int sz = 0; sz < world.subTiles; sz++)
                            {
                                ...
                                float density = pref.density * Mathf.Lerp(1, perl, pref.perlin) *
                                ...
                                for (int j = 0; j < count; j++)
                                {
                                    ...
                                    GameObject ob =
                                        GameObject.Instantiate(pref.prefab, p, RandomYRot(pref)) as GameObject;
                                    ob.transform.parent = root;
                                    //ob.SetActive ( false );
                                    //objs.Add ( ob );
                                    counter++;

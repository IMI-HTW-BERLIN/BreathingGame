...
namespace Pathfinding
{
    ...
    public class DynamicGridObstacle : GraphModifier
    {
        ...
        {
            get { return coll != null ? coll.enabled : coll2D.enabled; }
        }
        ...
        protected override void Awake()
        {
            ...
            {
                throw new System.Exception("A collider or 2D collider must be attached to the GameObject(" +
                                           gameObject.name + ") for the DynamicGridObstacle to work");
            }

...
namespace Pathfinding
{
    ...
    public static class EditorResourceHelper
    {
        ...
        public static Material GizmoLineMaterial
        {
            ...
            {
                if (!lineMat)
                    lineMat = UnityEditor.AssetDatabase.LoadAssetAtPath(
        ...
        public static bool LocateEditorAssets()
        {
            ...
            if (!System.IO.File.Exists(projectPath + editorAssets + "/AstarEditorSkinLight.guiskin") &&
                !System.IO.File.Exists(projectPath + editorAssets + "/AstarEditorSkin.guiskin"))
            {
                //Initiate search
                ...
                while (dirQueue.Count > 0)
                {
                    ...
                    if (System.IO.File.Exists(dir.FullName + "/AstarEditorSkinLight.guiskin") ||
                        System.IO.File.Exists(dir.FullName + "/AstarEditorSkin.guiskin"))
                    {

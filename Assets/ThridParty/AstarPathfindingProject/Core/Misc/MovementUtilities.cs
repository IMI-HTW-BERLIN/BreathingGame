...
namespace Pathfinding.Util
{
    public static class MovementUtilities
    {
        ...
        public static Vector2 CalculateAccelerationToReachPoint(Vector2 deltaPosition, Vector2 targetVelocity,
            Vector2 currentVelocity, float forwardsAcceleration, float rotationSpeed, float maxSpeed,
            Vector2 forwardsVector)
        {
            ...
            if (targetVelocity == Vector2.zero)
            {
                ...
                // Boosting
                {
                    ...
                    float ellipseMagnitude = finalAcceleration.x * finalAcceleration.x * ellipseSqrFactorX +

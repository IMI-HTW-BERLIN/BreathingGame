...
namespace Pathfinding
{
    ...
    public class GraphUpdateScene : GraphModifier
    {
        ...
        [HideInInspector] public bool legacyMode = false;
        ...
        [SerializeField] private int serializedVersion = 0;
        ...
        /// </summary>
        [SerializeField] [UnityEngine.Serialization.FormerlySerializedAs("useWorldSpace")]
        ...
        /// </summary>
        [System.ObsoleteAttribute("The Y coordinate is no longer important. Use the position of the object instead",
            true)]
        public void LockToY()
        {
        }

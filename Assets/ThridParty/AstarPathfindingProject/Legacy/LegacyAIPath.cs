    ...
    public class LegacyAIPath : AIPath
    {
        ...
        protected override void OnPathComplete(Path _p)
        {
            ...
            if (closestOnPathCheck)
            {
                ...
                Vector3 p1 = Time.time - lastFoundWaypointTime < 0.3f
                    ? lastFoundWaypointPosition
                    : p.originalStartPoint;
        ...
        protected new Vector3 CalculateVelocity(Vector3 currentPosition)
        {
            ...
            Vector3 targetPosition = CalculateTargetPoint(currentPosition, vPath[currentWaypointIndex - 1],

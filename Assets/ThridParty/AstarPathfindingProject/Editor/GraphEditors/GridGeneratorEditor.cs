...
namespace Pathfinding
{
    ...
    public class GridGraphEditor : GraphEditor
    {
        ...
        {
            return Mathf.Approximately(graph.isometricAngle, standardIsometric) &&
        ...
        protected virtual void Draw2DMode(GridGraph graph)
        {
            ...
            {
                graph.rotation = new2D
                    ? new Vector3(graph.rotation.y - 90, 270, 90)
                    : new Vector3(0, graph.rotation.x + 90, 0);
            }
        }

    ...
    public class RandomBrushEditor : GridBrushEditor
    {
        ...
        public override void PaintPreview(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            if (randomBrush.randomTileSets != null && randomBrush.randomTileSets.Length > 0)
            {
                ...
                {
                    var randomTileSet =
                        randomBrush.randomTileSets[
                            (int) (randomBrush.randomTileSets.Length * UnityEngine.Random.value)];
        ...
        public override void OnPaintInspectorGUI()
        {
            ...
            int randomTileSetCount = EditorGUILayout.DelayedIntField("Number of Tiles",

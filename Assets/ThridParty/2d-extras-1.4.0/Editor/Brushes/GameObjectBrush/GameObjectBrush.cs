...
namespace UnityEditor.Tilemaps
{
    ...
    {
        [SerializeField] [HideInInspector] private BrushCell[] m_Cells;

        [SerializeField] [HideInInspector] private Vector3Int m_Size;

        [SerializeField] [HideInInspector] private Vector3Int m_Pivot;
        ...
        public override void Rotate(RotationDirection direction, Grid.CellLayout layout)
        {
            ...
            Matrix4x4 rotation = Matrix4x4.TRS(Vector3.zero,
                Quaternion.Euler(0f, 0f, direction == RotationDirection.Clockwise ? 90f : -90f), Vector3.one);
            ...
            Vector3 offset, Vector3 scale, Quaternion orientation, Vector3 anchor)
        {
            ...
            instance.transform.position =
                grid.LocalToWorld(
                    grid.CellToLocalInterpolated(new Vector3Int(position.x, position.y, position.z) + anchor));
        ...
        public class BrushCell
        {
            ...
            [SerializeField] Quaternion m_Orientation = Quaternion.identity;
    ...
    public class GameObjectBrushEditor : GridBrushEditorBase
    {
        ...
        {
            get { return target as GameObjectBrush; }
        }

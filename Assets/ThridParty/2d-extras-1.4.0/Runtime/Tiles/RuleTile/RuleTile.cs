...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
        ...
        static Dictionary<Tilemap, KeyValuePair<HashSet<TileBase>, HashSet<Vector3Int>>>
        ...
        public virtual Matrix4x4 ApplyRandomTransform(TilingRule.Transform type, Matrix4x4 original, float perlinScale,
            Vector3Int position)
        {
            ...
            switch (type)
            {
                ...
                case TilingRule.Transform.Rotated:
                    int angle = Mathf.Clamp(Mathf.FloorToInt(perlin * m_RotationCount), 0, m_RotationCount - 1) *
                                m_RotationAngle;
